...
equilibria3_complex_dde<-function(muL = 0.248, muP_White = 0.25, muP_HG = 0.05, 
  ...
  #muP=0.1 #pupae daily mortality
  TL=10 #fixed larval development time
  #TP=2 #fixed pupal development time
  T0=2 #fixed egg development time
  muL_HG <- 0.1
  q0 <- q0
...
lhs <- function(){
  ...
  TL_range <- seq(0.5*10, 1.5*10, length.out = 101)
  T0_range <- seq(0.5*2, 1.5*2, length.out = 101)
